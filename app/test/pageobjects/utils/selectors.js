...
const selectors = {
     ...
     * @returns {string} Platform-specific selector
     */
    byContentDesc: (desc) => getSelector({
        ios: `~${desc}`,
     ...
     * @returns {string} Platform-specific selector
     */
    byStartsWithResourceId: (prefix) => getSelector({
     ...
     * @returns {string} Platform-specific selector
     */
    textContainsButNotContains: (containsText, excludesText) => getSelector({
     ...
     * @returns {string} Platform-specific selector
     */
    staticTextByIdPrefixAndPattern: (idPrefix, textPattern) => getSelector({
     ...
     * @returns {string} Platform-specific selector
     */
    spotlightItemsByPrefix: (prefix) => getSelector({
