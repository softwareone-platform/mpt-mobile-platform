...
class ProfilePage extends BasePage {
    ...
    get currentUserName () {
        return $(getSelector({
            ...
            android: '//android.view.ViewGroup[contains(@content-desc, "USR-")]//android.widget.TextView[1]'
        }));
    }
    ...
    get currentUserId () {
        return $(getSelector({
            ios: '//*[contains(@name, "USR-")]',
            android: '//android.view.ViewGroup[contains(@content-desc, "USR-")]//android.widget.TextView[contains(@text, "USR-")]'
        }));
    }
    ...
    get allAccountItems () {
        return $$(getSelector({
            ...
            android: '//android.view.ViewGroup[contains(@content-desc, "ACC-") and not(contains(@content-desc, "USR-"))][@clickable="true"]'
        }));
    }
