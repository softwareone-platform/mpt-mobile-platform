import ShoppingBasketOutlined from './shopping-backet';
import SellOutlined from './sell';
import FlareOutlined from './flare';
import MoreHorizOutlined from './more-horiz';
import AssignmentOutlined from './assignment';
...
export const OutlinedIcons = {
  'shopping-basket': ShoppingBasketOutlined,
  'sell': SellOutlined,
  'flare': FlareOutlined,
