...
describe('CredentialStorageService', () => {
    ...
    describe('loadUser', () => {
        ...
        it('should return null when no user data stored', async () => {
            ...
            expect(console.log).toHaveBeenCalledWith('No stored user data found');
        });
    ...
    describe('storeCredentials', () => {
        ...
        it('should handle error when storing credentials', async () => {
            ...
            await expect(credentialStorageService.storeCredentials(mockTokens, mockUser)).resolves.toBeUndefined();
            expect(console.error).toHaveBeenCalled();
        });
    });
